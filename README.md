...
This GitHub repository is the robot controller code developed by Darbots and is forked from the [FtcRobotController](https://github.com/FIRST-Tech-Challenge/FtcRobotController) repository.  
