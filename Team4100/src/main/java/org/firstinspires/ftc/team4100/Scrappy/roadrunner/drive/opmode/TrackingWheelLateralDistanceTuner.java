 ...
 * Tuning Routine:
 *
 * 1. Set the LATERAL_DISTANCE value in ScrappyOdometryPods.java to the physical
 ...
 * ScrappyOdometryPods.java class.
 *
...
public class TrackingWheelLateralDistanceTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (!(drive.getLocalizer() instanceof ScrappyOdometryPods)) {
            RobotLog.setGlobalErrorMsg("StandardTrackingWheelLocalizer is not being set in the "
                    + "drive class. Ensure that \"setLocalizer(new StandardTrackingWheelLocalizer"
                    + "(hardwareMap));\" is called in ScrappyChassis.java");
        }
        ...
        telemetry.addLine("Effective LATERAL_DISTANCE: " +
                (headingAccumulator / (NUM_TURNS * Math.PI * 2)) * ScrappyOdometryPods.LATERAL_DISTANCE);
