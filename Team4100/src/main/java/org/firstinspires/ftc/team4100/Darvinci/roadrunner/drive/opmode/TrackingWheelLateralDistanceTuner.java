 ...
 * Tuning Routine:
 *
 * 1. Set the LATERAL_DISTANCE value in RoadRunnerThreeWheelLocalizer.java to the physical
 ...
 * RoadRunnerThreeWheelLocalizer.java class.
 *
...
public class TrackingWheelLateralDistanceTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (!(drive.getLocalizer() instanceof RoadRunnerThreeWheelLocalizer)) {
            RobotLog.setGlobalErrorMsg("StandardTrackingWheelLocalizer is not being set in the "
                    + "drive class. Ensure that \"setLocalizer(new StandardTrackingWheelLocalizer"
                    + "(hardwareMap));\" is called in DarvinciChassis.java");
        }
        ...
        telemetry.addLine("Effective LATERAL_DISTANCE: " +
                (headingAccumulator / (NUM_TURNS * Math.PI * 2)) * RoadRunnerThreeWheelLocalizer.LATERAL_DISTANCE);
