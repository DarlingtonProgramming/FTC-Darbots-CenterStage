package org.firstinspires.ftc.team4100.Darvinci.roadrunner.util;
...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = DarvinciChassis.TRANSLATIONAL_PID.kP;
        public double mecTransI = DarvinciChassis.TRANSLATIONAL_PID.kI;
        public double mecTransD = DarvinciChassis.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = DarvinciChassis.HEADING_PID.kP;
        public double mecHeadingI = DarvinciChassis.HEADING_PID.kI;
        public double mecHeadingD = DarvinciChassis.HEADING_PID.kD;
        public double mecLateralMultiplier = DarvinciChassis.LATERAL_MULTIPLIER;

        public double trackingTicksPerRev = RoadRunnerThreeWheelLocalizer.TICKS_PER_REV;
        public double trackingWheelRadius = RoadRunnerThreeWheelLocalizer.WHEEL_RADIUS;
        public double trackingGearRatio = RoadRunnerThreeWheelLocalizer.GEAR_RATIO;
        public double trackingLateralDistance = RoadRunnerThreeWheelLocalizer.LATERAL_DISTANCE;
        public double trackingForwardOffset = RoadRunnerThreeWheelLocalizer.FORWARD_OFFSET;
