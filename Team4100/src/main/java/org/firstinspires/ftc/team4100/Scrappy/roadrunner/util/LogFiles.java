package org.firstinspires.ftc.team4100.Scrappy.roadrunner.util;
...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = ScrappyChassis.TRANSLATIONAL_PID.kP;
        public double mecTransI = ScrappyChassis.TRANSLATIONAL_PID.kI;
        public double mecTransD = ScrappyChassis.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = ScrappyChassis.HEADING_PID.kP;
        public double mecHeadingI = ScrappyChassis.HEADING_PID.kI;
        public double mecHeadingD = ScrappyChassis.HEADING_PID.kD;
        public double mecLateralMultiplier = ScrappyChassis.LATERAL_MULTIPLIER;

        public double trackingTicksPerRev = ScrappyOdometryPods.TICKS_PER_REV;
        public double trackingWheelRadius = ScrappyOdometryPods.WHEEL_RADIUS;
        public double trackingGearRatio = ScrappyOdometryPods.GEAR_RATIO;
        public double trackingLateralDistance = ScrappyOdometryPods.LATERAL_DISTANCE;
        public double trackingForwardOffset = ScrappyOdometryPods.FORWARD_OFFSET;
