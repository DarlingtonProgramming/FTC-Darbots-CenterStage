...
import org.firstinspires.ftc.team4100.Darvinci.util.KalmanFilter

class KalmanThreeWheelLocalizer(private val localizer: ThreeTrackingWheelLocalizer): ThreeTrackingWheelLocalizer(localizer.getWheelPoses()) {
        ...
        companion object {
                private fun ThreeTrackingWheelLocalizer.getWheelPoses(): List<Pose2d> {
                        ...
                        return listOf(
                                ...
                                Pose2d(0.0, -lateralDistance / 2, 0.0),
                                Pose2d(forwardOffset, 0.0, Math.toRadians(90.0))
                        )
                }
        }
}