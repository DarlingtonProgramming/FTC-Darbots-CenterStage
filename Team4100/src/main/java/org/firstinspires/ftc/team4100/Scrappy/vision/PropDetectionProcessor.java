...
public class PropDetectionProcessor implements VisionProcessor {
    ...
    private final ScrappyCore.AllianceType ALLIANCE_TYPE;
    private final ScrappyCore.AllianceSide ALLIANCE_SIDE;
    ...
    public PropDetectionProcessor(ScrappyCore.AllianceType allianceType, ScrappyCore.AllianceSide allianceSide) {
        this.ALLIANCE_TYPE = allianceType;
        this.ALLIANCE_SIDE = allianceSide;

        if (ALLIANCE_SIDE == ScrappyCore.AllianceSide.LEFT) {
            LEFT_RECTANGLE = new Rect(new Point(10, 270), new Point(155, 400));
            RIGHT_RECTANGLE = new Rect(new Point(350, 245), new Point(460, 350));
        } else {
            LEFT_RECTANGLE = new Rect(new Point(200, 235), new Point(320, 350));
            RIGHT_RECTANGLE = new Rect(new Point(535, 270), new Point(640, 410));
        }
    }
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        if (this.ALLIANCE_TYPE == ScrappyCore.AllianceType.RED) {
        ...
        double allianceBasedThreshold = ALLIANCE_TYPE == ScrappyCore.AllianceType.RED ? RED_THRESHOLD : BLUE_THRESHOLD;
