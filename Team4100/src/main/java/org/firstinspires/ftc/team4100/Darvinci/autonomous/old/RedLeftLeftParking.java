...
@Config
@Autonomous(name="Old Red [L, LP]", group="Old")
public class RedLeftLeftParking extends LinearOpMode {
    ...
    private final Pose2d START_POS = new Pose2d(-36.5, -62, Math.toRadians(270));
        ...
        if (opModeIsActive()) {
            if (DETECTION == PropDetectionProcessor.Detection.LEFT) {
                TrajectorySequence leftTraj = Drive.trajectorySequenceBuilder(START_POS)
                        ...
                        .lineToSplineHeading(new Pose2d(-35.5, -57.2, Math.toRadians(180)))
                        .lineToSplineHeading(new Pose2d(20, -57.2, Math.toRadians(180)))
                ...
                TrajectorySequence middleTraj = Drive.trajectorySequenceBuilder(START_POS)
                        ...
                        .lineToSplineHeading(new Pose2d(-39, -57.2, Math.toRadians(180)))
                        .lineToSplineHeading(new Pose2d(20, -57.2, Math.toRadians(180)))
                ...
                TrajectorySequence rightTraj = Drive.trajectorySequenceBuilder(START_POS)
                        .lineTo(new Vector2d(-39, -52.5),
                                //      230
                                DarvinciChassis.getVelocityConstraint(12, Math.toRadians(23), DriveConstants.TRACK_WIDTH),
                                DarvinciChassis.getAccelerationConstraint(12))
                        .lineToSplineHeading(new Pose2d(-32.5, -37, Math.toRadians(215)),
                                                                                //      230
                                DarvinciChassis.getVelocityConstraint(12, Math.toRadians(23), DriveConstants.TRACK_WIDTH),
                                DarvinciChassis.getAccelerationConstraint(12))
            ...
            if (aprilTagPose != null) {
                ...
                TrajectorySequence aprilTagTraj = Drive.trajectorySequenceBuilder(Drive.getPoseEstimate())
                        .lineToLinearHeading(new Pose2d(currentPose.getX() + (aprilTagPose.y - 2.2), currentPose.getY() + (DETECTION == PropDetectionProcessor.Detection.MIDDLE ? (aprilTagPose.x + 3.5) : (aprilTagPose.x + 2.5)), Math.toRadians(180)))
