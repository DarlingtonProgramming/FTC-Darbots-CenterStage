package org.firstinspires.ftc.team5100.MolotovCock.roadrunner.util;
...
import org.firstinspires.ftc.team5100.MolotovCock.roadrunner.drive.StandardTrackingWheelLocalizer;
...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = MolotovChassis.TRANSLATIONAL_PID.kP;
        public double mecTransI = MolotovChassis.TRANSLATIONAL_PID.kI;
        public double mecTransD = MolotovChassis.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = MolotovChassis.HEADING_PID.kP;
        public double mecHeadingI = MolotovChassis.HEADING_PID.kI;
        public double mecHeadingD = MolotovChassis.HEADING_PID.kD;
        public double mecLateralMultiplier = MolotovChassis.LATERAL_MULTIPLIER;
